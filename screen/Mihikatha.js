...
const Mihikatha = () => {
  ...
  const bannerimg = require('../assets/mihikatha.jpg');
  ...
  useEffect(() => {
    ...
    const playlistId = 'PLWQ5Ps8soI9g5COIwFn9fmuDYZHi9MyJb';
...
<Text style={styles.newsline}>Mihikatha Dinuwo</Text>
